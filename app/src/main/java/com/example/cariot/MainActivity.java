...
public class MainActivity extends AppCompatActivity implements SensorEventListener {
    ...
    private void getAccelerometer(SensorEvent event) {
        ...
        // Write a message to the database for accelerometer
        DatabaseReference mRef =  database.getReference().child("accelerometer");
        //DatabaseReference mRef =  database.getReference().child(dtf.format(now)).child(String.valueOf(i));
        Accelerometer acc = new Accelerometer(x,y,z);
        mRef.setValue(acc);
